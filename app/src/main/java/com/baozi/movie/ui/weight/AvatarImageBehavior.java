...
public class AvatarImageBehavior extends CoordinatorLayout.Behavior<AvatarImageView> {
    ...
    @Override
    public boolean layoutDependsOn(CoordinatorLayout parent, AvatarImageView child, View dependency) {
        // 依赖Toolbar控件
        return dependency instanceof Toolbar;
    }

    @Override
    public boolean onDependentViewChanged(CoordinatorLayout parent, AvatarImageView child, View dependency) {
        ...
        // 图片位置
        child.setY(mStartYPosition - distanceYToSubtract + DensityUtil.dip2px(mContext, 12));
        child.setX(mStartXPosition - distanceXToSubtract);

        // 图片大小
        CoordinatorLayout.LayoutParams lp = (CoordinatorLayout.LayoutParams) child.getLayoutParams();
        lp.width = (int) (mStartHeight - heightToSubtract + DensityUtil.dip2px(mContext, 10));
        lp.height = (int) (mStartHeight - heightToSubtract + DensityUtil.dip2px(mContext, 10));
     ...
     */
    private void shouldInitProperties(AvatarImageView child, View dependency) {
